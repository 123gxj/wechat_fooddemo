...
function code2Session($js_code = null)
{
    if($js_code)
    {
        $url = "https://api.weixin.qq.com/sns/jscode2session?appid=wx715533737a696032&secret=e96807de40112d88265c567357a4ac8e&js_code=$js_code&grant_type=authorization_code";
